...
public class ShopApp{
	...
	public static void main(String[]args){
		...
		System.out.println("How many Apples would you like? (type in whole integers please)");
		...
		System.out.println("How many Bananas would you like? (type in whole integers please)");

		bananas=keyboard.nextInt();

		System.out.println("How much Milk would you like? (type in whole interges please)");

		milk=keyboard.nextInt();

		System.out.println("How much Bread would you like? (type in whole interges please)");
